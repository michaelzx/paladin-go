...
const (
	...
	FileTypeEml        FileType = "eml"
	FileTypeDoc        FileType = "doc"
	FileTypeVsd        FileType = "vsd"
	FileTypeMdb        FileType = "mdb"
	FileTypePs         FileType = "ps"
	FileTypePdf        FileType = "pdf"
	FileTypeRmvb       FileType = "rmvb"
	...
	FileTypeMid        FileType = "mid"
	FileTypeZip        FileType = "zip"
	FileTypeRar        FileType = "rar"
	FileTypeIni        FileType = "ini"
	FileTypeJar        FileType = "jar"
	FileTypeExe        FileType = "exe"
	FileTypeJsp        FileType = "jsp"
	FileTypeMf         FileType = "mf"
	FileTypeXml        FileType = "xml"
	FileTypeSql        FileType = "sql"
	FileTypeJava       FileType = "java"
	FileTypeBat        FileType = "bat"
	FileTypeGz         FileType = "gz"
	FileTypeProperties FileType = "properties"
	FileTypeClass      FileType = "class"
	FileTypeChm        FileType = "chm"
	FileTypeMxp        FileType = "mxp"
	FileTypeDocx       FileType = "docx"
	FileTypeWps        FileType = "wps"
	FileTypeTorrent    FileType = "torrent"
	FileTypeMov        FileType = "mov"
	FileTypeWpd        FileType = "wpd"
	FileTypeDbx        FileType = "dbx"
	FileTypePst        FileType = "pst"
	FileTypeQdf        FileType = "qdf"
	FileTypePwl        FileType = "pwl"
	FileTypeRam        FileType = "ram"
)
